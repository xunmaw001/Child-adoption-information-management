...
public class ShouyangGenggaiView extends ShouyangGenggaiEntity implements Serializable {
	...
	public ShouyangGenggaiView() {

	}

	public ShouyangGenggaiView(ShouyangGenggaiEntity shouyangGenggaiEntity) {
		try {
			BeanUtils.copyProperties(this, shouyangGenggaiEntity);
