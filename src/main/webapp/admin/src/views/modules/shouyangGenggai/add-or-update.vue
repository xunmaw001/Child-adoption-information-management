    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shouyangId" name="shouyangId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="修改前" prop="xiugaiqianText">
                        <el-input type="textarea"  :readonly="ro.xiugaiqianText" v-model="ruleForm.xiugaiqianText" placeholder="修改前"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiugaiqianText" label="修改前" prop="xiugaiqianText">
                            <span v-html="ruleForm.xiugaiqianText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="修改后" prop="xiugaihouText">
                        <el-input type="textarea"  :readonly="ro.xiugaihouText" v-model="ruleForm.xiugaihouText" placeholder="修改后"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.xiugaihouText" label="修改后" prop="xiugaihouText">
                            <span v-html="ruleForm.xiugaihouText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xiugaiqianText: [
                              { required: true, message: '修改前不能为空', trigger: 'blur' },
                          ],
                   xiugaihouText: [
                              { required: true, message: '修改后不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shouyangGenggai/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shouyangGenggaiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
